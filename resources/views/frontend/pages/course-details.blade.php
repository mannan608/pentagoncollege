        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="grid grid-cols-1 md:grid-cols-[70%_30%] gap-6 md:gap-0">
                <div class="content pr-0 md:pr-8 lg:pr-10">
                    <img src="{{ asset('penta-img/course_5.jpg') }}" alt="" class="object-cover rounded-2xl">

                    <div class="mt-5 flex flex-col lg:flex-row gap-6 lg:gap-10">

                        <!-- Course Info -->
                        <div class="flex-1">
                            <ul class="list-disc pl-5 space-y-2 text-neutral-600 text-sm md:text-base">
                                <li>
                                    <span class="font-medium text-neutral-900">Course Code:</span>
                                    ICT60220 | CRICOS 109180H
                                </li>
                        ...
                        <div class="w-full lg:w-auto lg:min-w-65 flex flex-col items-start lg:items-center gap-4">
                            ...
                            <button type="button" data-open-apply-modal
                                class="w-full lg:w-auto bg-brand-600 hover:bg-brand-600 text-white text-sm md:text-base px-5 py-3 rounded-xl font-medium transition-all duration-300">
                                Enroll Course
                            </button>
                ...
                <div class="related-courses">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <a href="#" class="group block">
                            <div class="overflow-hidden rounded-2xl border border-brand-500/10">
                                <div class="aspect-16/10 overflow-hidden">
                                    <img src="{{ asset('penta-img/course_1.jpg') }}"
                                        alt="Advanced Diploma of Information Technology"
                        ...
                        <a href="#" class="group block">
                            <div class="overflow-hidden rounded-2xl border border-brand-500/10">
                                <div class="aspect-16/10 overflow-hidden">
                                    <img src="{{ asset('penta-img/course_2.jpg') }}" alt="Diploma of Information Technology"
                                        class="w-full h-full object-cover transition duration-500 group-hover:scale-105">
                                </div>
                        ...
                        <a href="#" class="group block">
                            <div class="overflow-hidden rounded-2xl border border-brand-500/10">
                                <div class="aspect-16/10 overflow-hidden">
                                    <img src="{{ asset('penta-img/course_3.jpg') }}"
